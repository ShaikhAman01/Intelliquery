...
export default function SignUpPage() {
    return (
        <div className="flex min-h-screen items-center justify-center bg-[#09090b] p-4 relative antialiased">
            {/* Consistent Grid Background Tokens */}
            ...
            <div className="z-10 w-full max-w-[420px] space-y-6">
                <div className="flex flex-col items-center gap-2 text-center select-none">
                    ...
                    <p className="text-xs text-slate-400">Get started with Intelliquery pipeline nodes</p>
                </div>

                <Suspense fallback={
                    <div className="flex flex-col items-center justify-center space-y-3 text-slate-400 bg-[#111214] border border-white/[0.06] rounded-2xl p-8 h-[420px]">
                        <Loader2 className="h-5 w-5 animate-spin text-slate-400" />
                        <p className="text-xs font-medium tracking-wide text-slate-500 uppercase">Constructing credentials profile</p>
                    </div>
                }>
