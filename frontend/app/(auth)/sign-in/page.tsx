...
const FEATURES = [
  ...
  { Icon: BarChart3,     text: 'Instant charts, KPIs, and AI-powered insights' },
  { Icon: ShieldCheck,   text: 'Read-only by default — safe to connect production databases' },
];
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="mt-4 text-[15px] text-white/70 leading-relaxed">
              Connect any database, ask natural language questions, and get instant SQL results with AI-powered insights.
            </p>
          </div>
