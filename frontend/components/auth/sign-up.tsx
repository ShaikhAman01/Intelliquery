  ...
  return (
    <div className="w-full space-y-6">
      <div className="space-y-1">
        <h2 className="text-[22px] font-bold tracking-tight text-content-1">Create an account</h2>
        <p className="text-[14px] text-content-3">Start querying your data in plain English</p>
      </div>

      <form onSubmit={handleSignUp} className="space-y-4">
        <div className="space-y-2">
          <Label htmlFor="name" className="text-[13px] font-medium text-content-2">Full name</Label>
          <Input
            id="name"
            type="text"
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center">
          <span className="px-3 text-[12px] text-content-3" style={{ background: 'var(--ds-base-0)' }}>
            or sign up with
          </span>
        </div>
      </div>
      ...
      <p className="text-center text-[11px] text-content-3 leading-relaxed">
        By creating an account you agree to our{' '}
        <Link href="/terms" className="underline hover:text-content-1 transition-colors">Terms of Service</Link>
        {' '}and{' '}
        <Link href="/privacy" className="underline hover:text-content-1 transition-colors">Privacy Policy</Link>
      </p>
    </div>
  );
}
